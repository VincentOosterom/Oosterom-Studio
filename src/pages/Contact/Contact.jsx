    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Vraag een gratis strategiegesprek aan bij Oosterom Studio. Binnen 24 uur reactie. Wij bouwen websites, webshops en beveiligde digitale oplossingen voor MKB en startups." />
                <meta property="og:title" content="Contact | Oosterom Studio" />
                <meta property="og:description" content="Klaar om jouw project te starten? Plan een vrijblijvend gesprek en ontvang binnen 24 uur een reactie." />
                    ...
                    <div className="contact-layout">
                                ...
                                <div className="company-details">
                                    ...
                                    <div className="company-details-extra">
                                        ...
                                        <a
                                            ...
                                            className="document-link document-link--icon"
                                            aria-label="LinkedIn"
                                        >
                        ...
                        {!isSubmitted ? (
                            ...
                            >
                                ...
                                <textarea name="message" placeholder="Waar kunnen we je bij helpen? *" value={formData.message} onChange={handleChange} rows="5" required />
