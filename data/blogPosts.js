export const blogPosts = [
    ...
    {
        slug: "wat-kost-een-website-2026",
        title: "Wat kost een website in 2026? Een eerlijke prijsindicatie voor MKB",
        excerpt:
            "Websiteprijzen lopen uiteen van €500 tot €15.000+. Deze factoren bepalen waar jouw project op uitkomt, en waarom de goedkoopste optie vaak duurder uitpakt.",
        categorie: "Webdesign",
        datum: "2026-06-20",
        leestijd: "6 min",
        intro:
            "<p>'Wat kost een website?' is de vraag die we het vaakst krijgen, en het eerlijke antwoord is: het hangt af van wat je nodig hebt. Deze gids geeft je de factoren die de prijs echt bepalen, zodat je een offerte kan beoordelen in plaats van alleen op het eindbedrag te letten.</p>",
        secties: [
            {
                kop: "Waarom 'gewoon een website' niet bestaat",
                html:
                    "<p>Een eenvoudige brochurewebsite van vijf pagina's kost iets heel anders dan een site met een klantportaal, meertaligheid of maatwerk functionaliteit. De prijs zit 'm niet in het aantal pagina's, maar in de techniek erachter.</p><p>Bij <a href=\"/diensten/webdesign\">webdesign &amp; UX</a> bepalen we daarom altijd eerst wat je site moet kunnen doen, voordat we over een bedrag praten.</p>",
            },
            {
        ...
        gerelateerdeBlogs: ["ux-design-conversie", "onderhoudsabonnement-of-losse-facturen"],
    },
    {
        slug: "core-web-vitals-uitgelegd",
        title: "Core Web Vitals uitgelegd: waarom een trage website je omzet kost",
        excerpt:
            "Google beoordeelt je website op laadsnelheid en stabiliteit. Wat Core Web Vitals precies meten, en waarom ze direct invloed hebben op je vindbaarheid.",
        categorie: "Webdesign",
        datum: "2026-06-24",
        leestijd: "5 min",
        intro:
            "<p>Sinds Google laadsnelheid meeweegt in de zoekresultaten, is een trage website niet alleen vervelend voor bezoekers, het kost je ook rankings. Core Web Vitals zijn de meetlat waarmee Google dat beoordeelt.</p>",
        secties: [
            {
                kop: "De drie metingen die er echt toe doen",
                html:
                    "<p>Core Web Vitals bestaan uit drie kernmetingen: hoe snel de grootste content zichtbaar wordt (LCP), hoe snel de site reageert op een klik (INP), en hoe stabiel de pagina blijft tijdens het laden (CLS). Score je slecht op één van deze drie, dan kan dat je positie in Google beïnvloeden, ook als de rest van je site goed is.</p>",
            },
            {
                kop: "Waar de meeste MKB-websites op verliezen",
                html:
                    "<p>Ongeoptimaliseerde afbeeldingen, te veel losse scripts van plugins, en gedeelde hosting zijn de meest voorkomende boosdoeners. Dit zijn ook precies de punten waar veel websitebouwers, in tegenstelling tot <a href=\"/diensten/webdevelopment\">webdevelopment &amp; applicaties</a> op maat, geen grip op hebben omdat ze op een standaardplatform draaien.</p>",
            },
            {
        ...
        gerelateerdeBlogs: ["ux-design-conversie"],
    },
    {
        slug: "klantportaal-vs-crm",
        title: "Klantportaal of CRM: wat heeft jouw bedrijf eigenlijk nodig?",
        excerpt:
            "De termen worden vaak door elkaar gebruikt, maar een klantportaal en een CRM lossen verschillende problemen op. Dit is het verschil, in gewone taal.",
        categorie: "Software",
        datum: "2026-06-27",
        leestijd: "5 min",
        intro:
            "<p>'We willen een CRM' en 'we willen een klantportaal' klinken hetzelfde, maar leiden vaak tot iets heel anders. Het verschil zit in wie het systeem gebruikt: jij intern, of je klant zelf.</p>",
        secties: [
            {
                kop: "CRM: overzicht voor jouw team",
                html:
                    "<p>Een CRM is in de eerste plaats een intern werkinstrument. Het houdt leads, klantcontact en verkoopkansen bij, zodat jouw team weet wie waar in het proces zit. De klant zelf logt hier meestal niet zelf in.</p>",
            },
            {
                kop: "Klantportaal: zelfbediening voor je klant",
                html:
                    "<p>Een klantportaal draait het om: hier kan de klant zélf inloggen om status te bekijken, documenten te downloaden of een aanvraag in te dienen. Dat scheelt telefoontjes en e-mails over 'waar staat mijn project nu'.</p><p>Bij <a href=\"/diensten/klantportaal\">klantportalen &amp; CRM</a> bouwen we regelmatig een combinatie: een CRM-achtige backend voor jouw team, gekoppeld aan een portaal waar de klant een beperkt, relevant deel van diezelfde data ziet.</p>",
            },
            {
    ...
    {
        slug: "mvp-bouwen-stappen",
        title: "Een MVP bouwen voor je SaaS-idee: de stappen die je niet mag overslaan",
        excerpt:
            "Een MVP is geen halve versie van je product, het is de kleinste versie die al waarde levert. Deze stappen voorkomen dat je te vroeg te veel bouwt.",
        categorie: "Software",
        datum: "2026-07-02",
        leestijd: "6 min",
        intro:
            "<p>De meest gemaakte fout bij een eerste SaaS-product is te veel bouwen voordat er ook maar één gebruiker is geweest. Een MVP (Minimum Viable Product) voorkomt dat, mits je hem goed opzet.</p>",
        secties: [
            {
                kop: "Stap 1: bepaal het ene probleem dat je oplost",
                html:
                    "<p>Een MVP faalt meestal niet door slechte code, maar door een te breed startpunt. Kies één kernprobleem en bouw daar de kleinst mogelijke, werkende oplossing voor, niks meer.</p>",
            },
            {
                kop: "Stap 2: ontwerp de datastructuur voordat je ontwerpt hoe het eruitziet",
                html:
                    "<p>Een mooie interface op een verkeerd opgezette database kost je later een volledige herbouw. Bij <a href=\"/diensten/saas\">SaaS &amp; digitale systemen</a> beginnen we daarom altijd met de database-architectuur en gebruikersrollen, pas daarna met het scherm zelf.</p>",
            },
            {
                kop: "Stap 3: bouw voor de eerste 10 gebruikers, niet voor 10.000",
                html:
                    "<p>Schaalbaarheid is belangrijk, maar over-engineeren voor een gebruikersaantal dat je nog niet hebt, kost tijd die je beter besteedt aan het testen van je aannames bij echte gebruikers.</p>",
            },
            {
        ...
        gerelateerdeBlogs: ["wat-is-een-ai-agent", "wanneer-loont-maatwerk-software"],
    },
];